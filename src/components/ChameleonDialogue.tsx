...
export const ChameleonDialogue = ({ onComplete }: ChameleonDialogueProps) => {
  ...
  return (
    <div className="flex items-end space-x-2 sm:space-x-4 cursor-pointer px-2 sm:px-4" onClick={handleClick}>
      ...
      `}>
        <img 
          ...
          className="w-29 h-29 sm:w-36 sm:h-36 md:w-48 md:h-48 object-contain filter drop-shadow-lg"
